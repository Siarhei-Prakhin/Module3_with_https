...
TOMCAT_COUNT = $tomcat
  ...
  config.vm.define "HTTPD-node" do |node1|
    ...
    node1.vm.network "forwarded_port", guest: 443, host: 8444, host_ip: "127.0.0.1"
    node1.vm.provision "shell", inline: "
        yum install httpd wget httpd-devel gcc make redhat-rpm-config mod_ssl -y
        setenforce 0
        ...
        openssl req \
            ...
            -keyout /etc/httpd/ssh/module3.key \
            -out /etc/httpd/ssh/module3.crt
    ...
    node1.vm.provision "file", source: "./vhost_jk.conf", destination: "/home/vagrant/"
    node1.vm.provision "shell", inline: "mv /home/vagrant/vhost_jk.conf /etc/httpd/conf.modules.d/"
...
#      node.vm.provision "shell", path: "/home/vagrant/tomcat9/bin/shutdown.sh"
#      node.vm.provision "shell", path: "/home/vagrant/tomcat9/bin/startup.sh"
      node.vm.provision "shell", inline: "
          cd /home/vagrant/tomcat9/bin
          ./shutdown.sh
          ./startup.sh
      "
